...
export const createBankAccount = async ({
    ...
    try {
        // Create a bank account(within Appwrite DB) as a document
...
// Create exchange public token for the purpose of facilitating banking activities (e.g connecting bank accounts, payment transfers/processors etc.)
...
export const exchangePublicToken = async ({
    ...
    try {
      ...
      // Revalidate the path to reflect the changes after account creation on home page
        revalidatePath("/");
